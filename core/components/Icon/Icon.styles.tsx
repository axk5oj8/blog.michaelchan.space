...
export const StyledSVG = styled('svg', {
  variants: {
    variant: {
      ...
      primary: {
        stroke: 'var(--colors-typeface-primary)',
        fill: 'none',
      },
      secondary: {
        stroke: 'var(--colors-typeface-secondary)',
        fill: 'none',
      },
      tertiary: {
        stroke: 'var(--colors-typeface-tertiary)',
        fill: 'none',
      },
      info: {
        stroke: 'var(--colors-brand)',
        fill: 'var(--colors-emphasis)',
      },
      danger: {
        stroke: 'var(--colors-danger)',
        fill: 'var(--colors-danger-emphasis)',
      },
      success: {
        stroke: 'var(--colors-success)',
        fill: 'var(--colors-success-emphasis)',
      },
      warning: {
        stroke: 'var(--colors-warning)',
        fill: 'var(--colors-warning-emphasis)',
      },
    },
    outline: {
      true: {
