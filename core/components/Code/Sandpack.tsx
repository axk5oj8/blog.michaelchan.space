...
const theme = {
  colors: {
    hover: 'var(--colors-brand)',
    clickable: 'var(--colors-typeface-secondary)',
    accent: 'var(--colors-brand)',
    errorSurface: 'var(--colors-danger-emphasis)',
    error: 'var(--colors-danger)',
    surface3: 'var(--colors-emphasis)',
...
const SandpackWrapper = styled('div', {
  ...
  '.button': {
    backgroundColor: 'var(--colors-body)!important',
