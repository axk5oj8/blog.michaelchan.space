  ...
  variants: {
    ...
    outline: {
      true: {
        ...
        WebkitTextStrokeColor: 'var(--colors-typeface-primary)',
    ...
    variant: {
      ...
      primary: { color: 'var(--colors-typeface-primary)' },
      secondary: { color: 'var(--colors-typeface-secondary)' },
      tertiary: { color: 'var(--colors-typeface-tertiary)' },
      info: { color: 'var(--colors-brand)' },
      success: { color: 'var(--colors-success)' },
      warning: { color: 'var(--colors-warning)' },
      danger: { color: 'var(--colors-danger)' },
    },
    weight: {
      1: {
